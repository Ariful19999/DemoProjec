...
import com.arif19.noticemanagement.modal.AddGroupMemberItem;
import com.arif19.noticemanagement.recycleview.AddGroupMemberAdapter;
...
public class all_group_member extends AppCompatActivity {
    ...
    String groupId="-1";
    String groupName="";
    AppCompatButton removeSelectedMember;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButtonProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(all_group_member.this, group_post.class);
        ...
        if (intent != null && intent.hasExtra("groupId")) {
            ...
            Intent iiiii = new Intent(all_group_member.this, all_group.class);
            startActivity(iiiii);
        }
        //// end /////
        ...
        removeSelectedMember = findViewById(R.id.removeSelectedMember);
        removeSelectedMember.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void fetchMemberData() {
        ...
        String apiUrl = rootUrl + "VDB/find_group_member.php";
        //String apiUrl = rootUrl + "VDB/";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, apiUrl, jsonData,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status.equals("Success")) {
                                ...
                                Toast.makeText(all_group_member.this, "Something is Wrong!", Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(all_group_member.this, "Error: " + error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void sendData(ArrayList<String> selectedMemberId) {
        ...
        if(selectedMemberId.size()==0){
            Toast.makeText(all_group_member.this, "Select Member First", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        String apiUrl = rootUrl + "VDB/remove_group_member.php";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, apiUrl, jsonData,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                addGroupMemberAdapterItems.clear();
                                addGroupMemberAdapter.notifyDataSetChanged();
                                fetchMemberData();

                                Toast.makeText(all_group_member.this, message, Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(all_group_member.this, "Something is Wrong!", Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
